...
<body>
  ...
  <div id="nav">
    <h1 class="logo"><a href="http://127.0.0.1:8000/">Search</a></h1>
    <!-- 헤더공백  -->
    <nav>
      <ul>
        {% if user.is_active %}
        <li class="menu"><a href="http://127.0.0.1:8000/signup">Signup</a></li>
        {%else%} <li class="menu"><a href="http://127.0.0.1:8000/login">Login</a></li>
        {%endif%}
      </ul>
